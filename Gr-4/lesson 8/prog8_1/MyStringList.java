...
public class MyStringList {
	...
	public static void main(String[] args) {
		...
		System.out.println(l);
		System.out.println(l.search("Mark"));
		/*
		 * System.out.println("The list of size " + l.size() + " is " + l);
		 * l.remove("Mark"); l.remove("Bob");
		 * System.out.println("The list of size " + l.size() + " is " + l);
		 * l.insert("Richard", 3); System.out.println("The list of size " +
		 * l.size() + " after inserting Richard into pos 3 is " + l);
		 * l.insert("Tonya", 0); System.out.println("The list of size " +
		 * l.size() + " after inserting Tonya into pos 0 is " + l);
		 */
	}
