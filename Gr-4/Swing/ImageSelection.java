...
public class ImageSelection extends JFrame{
    ...
    ImageSelection(){
       ...
       /* image1=new ImageIcon("https://pixabay.com/en/human-india-hindu-portrait-613601/");
        label1=new JLabel(image1);
        label1.setPreferredSize(new Dimension(300, 100)); 
        label1.addMouseListener(new MouseListener()
        { @Override
            public void mouseClicked(MouseEvent e){  label4.setText("Mr.x");}
        ...
        image2=new ImageIcon("D://bmrs//Helloworld//images.jpg");
        label2=new JLabel(image2);
        label2.setPreferredSize(new Dimension(300, 100));
        label2.addMouseListener(new MouseListener()
        { @Override
            public void mouseClicked(MouseEvent e){  label2.setText("  The Name is X, Mr X ");}
            public void mousePressed(MouseEvent e){ }
            public void mouseExited(MouseEvent e){  }
            public void mouseEntered(MouseEvent e){ }
            public void mouseReleased(MouseEvent e) {  }
