...
public class Main {
	...
	/**
	 * Combines the lists that are populated here into a single list and passes
	 * to computeSumOfSalaries
	 */
	...
	// IMPLEMENT
	public static List<EmployeeData> combine(List<Staff> staff,
